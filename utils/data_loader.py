...
def remap_item(train_data, test_data):
    ...
    for u_id, i_id in train_data:
        ...
        item_set[int(i_id)].append(int(u_id))
...
def load_data(model_args):
    ...
    kg_file = directory + 'kg_final.txt'
    ...
    # max_len = 0
    # max_key = 0
    # for key,value in train_user_set.items():
    ...
    # print(max_len)
    # print(min_len)
    # print(train_user_set[max_key])
    


    # head_num = int(0.5*n_users)
    # for d in range(max_len):
    #     count = 0
    #     for key,value in train_user_set.items():
    #         if(len(value)) > d:
    #             count += 1
    #     if count < head_num + 10000 and count > head_num - 10000:
    #         degree = d
    #         print(d)
